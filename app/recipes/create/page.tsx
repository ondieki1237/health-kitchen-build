...
export default function CreateRecipePage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            router.push("/planner") // Or redirect to recipe list
        } catch (error) {
            console.error(error)
    ...
    return (
        <div className="min-h-screen bg-[#f9faf7]">
            <Header user={null} onLogout={() => { }} /> {/* Pass user if needed or fetch in layout */}
            ...
            <main className="max-w-4xl mx-auto p-6 md:p-8">
                ...
                <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-8">
                    <h1 className="text-3xl font-bold text-[#2e7d32] mb-8 flex items-center gap-3">
                        <span className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center text-green-700">
                                    ...
                                    <div key={idx} className="flex gap-3 items-start">
                                        ...
                                        <Textarea
                                            ...
                                            onChange={e => {
                                                ...
                                                newInst[idx] = { ...newInst[idx], instruction: e.target.value }
